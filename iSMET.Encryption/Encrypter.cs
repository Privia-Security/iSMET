...
namespace iSMET.Encryption
{
    ...
    {
        /// <summary>
        /// Shellcode Encrypter Class with RSA Algorithm
        /// </summary>
        public class RSA
        {
            ...
            public void generateKeys()
            {
                using (var rSACryptoServiceProvider = new RSACryptoServiceProvider(2048))
                {
                    ...
                    this.publicKey = rSACryptoServiceProvider.ToXmlString(false);
                    this.privateKey = rSACryptoServiceProvider.ToXmlString(true);
                }
            }
        ...
        /// <summary>
        /// Shellcode Encrypter Class with DES Algorithm
        /// </summary>
        public class DES
        {
            public string Encrypt(string strData, string strKey)
            {
                var rgbKey = new byte[0];
                var rgbIV = new byte[]
                {
                    10,
                    20,
                ...
                try
                {
                    rgbKey = Encoding.UTF8.GetBytes(strKey);
        ...
        /// <summary>
        /// Shellcode Encrypter Class with 3DES Algorithm
        /// </summary>
        public class TripleDES
        {
            public string Encrypt(string source, string key)
            {
                ...
                var key2 = mD5CryptoServiceProvider.ComputeHash(Encoding.UTF8.GetBytes(key));
        ...
        /// <summary>
        /// Shellcode Encrypter Class with RC2 Algorithm
        /// </summary>
        public class RCTwo
        {
            public void EncryptTextToFile(string Data, string FileName, byte[] Key, byte[] IV)
            {
                try
                {
                    ...
                    var rC = RC2.Create();
                    var cryptoStream = new CryptoStream(fileStream, rC.CreateEncryptor(Key, IV), CryptoStreamMode.Write);
                ...
                {
                    Console.WriteLine("A file error occurred: {0}", ex2.Message);
                }
            }
        }
        /// <summary>
        /// Shellcode Encrypter Class with Rinjdael Algorithm
        /// </summary>
        public class Rijndael
        {
            public string EncryptText(string input, string password)
            {
                ...
                var array = Encoding.UTF8.GetBytes(password);
                array = SHA256.Create().ComputeHash(array);
                var inArray = AES_Encrypt(bytes, array);
            ...
            private byte[] AES_Encrypt(byte[] bytesToBeEncrypted, byte[] passwordBytes)
            {
                ...
                using (var memoryStream = new MemoryStream())
                {
                    using (var rijndaelManaged = new RijndaelManaged())
                    {
                        ...
                        var rfc2898DeriveBytes = new Rfc2898DeriveBytes(passwordBytes, salt, 1000);
        ...
        /// <summary>
        /// Shellcode Encrypter Class with AES-CBC Algorithm
        /// </summary>
        public class AESCBC
        {
            ...
            public static byte[] EncryptStrings(string password, String message)
            {
        ...
        /// <summary>
        /// Shellcode Encrypter Class with Blowfish Algorithm
        /// </summary>
        public class BlowFish
        {
            ...
            {
                BlowFish fish = new BlowFish(IV);
                string result = fish.Encrypt_CBC(data);
                return result;
            }
        }
    }
